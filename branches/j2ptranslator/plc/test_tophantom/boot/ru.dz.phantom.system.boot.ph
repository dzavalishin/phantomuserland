...
import .ru.dz.phantom.system.translation_regression_tests;
...
//    var reg_test_class;
    var trans_test : .ru.dz.phantom.system.translation_regression_tests;
    ...
    void do_startup(var _boot_object : .internal.object @const )
    {
        ...
        trans_test = new .ru.dz.phantom.system.translation_regression_tests();
        print("Starting compiler translation tests\n");
        trans_test.run(boot_object);
        print("Finished compiler translation tests\n");
