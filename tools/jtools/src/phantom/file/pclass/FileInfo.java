...
public abstract class FileInfo {
	...
	public void write() throws IOException {
		if( written ) throw new IOException( "FileInfo::write: already written "+toString() );
	...
	protected abstract void do_write_specific() throws IOException;
