    ...
    UINT32                  *TableIndex)
{
    ...
    ACPI_STRNCPY (Header.Signature, Signature, ACPI_NAME_SIZE-1);
    ACPI_STRNCPY (Header.OemId, OemId, ACPI_OEM_ID_SIZE-1);
    ACPI_STRNCPY (Header.OemTableId, OemTableId, ACPI_OEM_TABLE_ID_SIZE-1);
