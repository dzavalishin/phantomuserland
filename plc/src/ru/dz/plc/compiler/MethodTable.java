...
public class MethodTable {
  ...
  //static int nextord = 16; // BUG! Hack. In normal situation we will start from Method no, whichi sfirst not used number in parent. For now we start from 16 just to make sure user Method will not get 'internal' (reserved) number by mistake
  //int nextord = 0;
