...
static int tulip_probe(phantom_device_t * dev);
static void tulip_init_ring(phantom_device_t *dev);
static void tulip_reset(phantom_device_t *dev);
static void tulip_transmit(phantom_device_t *dev, const char *d, unsigned int t,
                           unsigned int s, const char *p);
static int tulip_poll(phantom_device_t *dev);
...
int mdio_read(phantom_device_t *dev __unused, int phy_id, int location)
{
    int i;
...
void mdio_write(phantom_device_t *dev __unused, int phy_id, int location, int value)
{
    int i;
...
/*********************************************************************/
static void tulip_init_ring(phantom_device_t *dev __unused)
{
    int i;
...
static void set_rx_mode(phantom_device_t *dev __unused) {
