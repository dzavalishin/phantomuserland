...
static void arp_retransmit_thread(void)
{
    arp_wait_request *wait;
    arp_wait_request *removed_waiters;
    arp_wait_request *last;
...
static void arp_cleanup_thread(void)
{
    arp_cache_entry *e;
...
int arp_init(void)
{
    hal_mutex_init(&arp_table_mutex, "arp table");
    hal_mutex_init(&arp_wait_mutex, "arp wait");
    //arp_wait_sem = sem_create(0, "arp_wait_sem");
    hal_sem_init(&arp_wait_sem, "arp sem");
