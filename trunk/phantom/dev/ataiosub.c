...
void sub_zero_return_data( ataio_t *ata )
{
    int ndx;
...
void sub_setup_command( ataio_t *ata )
{
    unsigned char dev75;
...
unsigned char sub_readBusMstrCmd( ataio_t *ata )
{
    unsigned char x;
...
unsigned char sub_readBusMstrStatus( ataio_t *ata )
{
    unsigned char x;
...
void sub_writeBusMstrCmd( ataio_t *ata, unsigned char x )
{
...
void sub_writeBusMstrStatus( ataio_t *ata, unsigned char x )
