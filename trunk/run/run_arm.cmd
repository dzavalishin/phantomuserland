...
rm -f serial0.log 
start /wait %QDIR%\qemu-system-arm -gdb tcp::1234,nowait,nodelay,server,ipv4 -L %QDIR%/bios -kernel fat/boot/phantom -sd phantom.img -mtdblock vio.img %SER% %STOP% %Q_NET% 
