...
#define outl_reverse(__r_val, __r_addr) outl(__r_addr, __r_val )
#define outw_reverse(__r_val, __r_addr) outw(__r_addr, __r_val )
#define outb_reverse(__r_val, __r_addr) outb(__r_addr, __r_val )
